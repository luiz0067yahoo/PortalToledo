...
class noticiasFotosDAO{
    ...
    public function __construct(){
        $this->table="noticias_fotos";
        //$this->table_alias="noticias_fotos";
        $this->joins="  left join noticias on (noticias.id=noticias_fotos.id_noticia) ";
        $this->fields=array(
    		"id"=>array("nome"=>"Código","tipo"=>"integer","nome_banco"=>"id")
    		,"id_noticia"=>array("nome"=>"Código Notícia","tipo"=>"integer fk","nome_banco"=>"noticias_fotos.id_noticia")	
    		,"noticia"=>array("nome"=>"Noticia","tipo"=>"varchar(50)","nome_banco"=>"noticias.titulo as noticia")
