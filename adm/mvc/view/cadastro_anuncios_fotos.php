...
<br>
<div class="container">
	<h1>CADASTRO DE FOTOS DE ANUNCIOS </h1>
	<br>
	<br>
	<div class="row">
		<div class="sm-12">
			<form class="cadastro" id="cadastro_anuncio" action="/adm/mvc/model/anunciosFotosDAO.php" method="POST" enctype="multipart/form-data">
				...
				<div class="form-row align-items-center">
						...
						<div class="input-group mb-3">
							<label class="sr-only" for="inlineFormInputGroupcodigoanuncios">codigo anúncios</label>
							<div class="input-group-prepend">
								<div class="input-group-text">
									<i class="fa fa-key" aria-hidden="true"></i>
								</div>
							</div>
							<input type="number" disabled data-bind="value:replyNumber" class="form-control" id="inlineFormInputGroupcodigoanuncios" placeholder="Código Anúncios" name="id_anuncio" value="<?php if(issetParameter("id_anuncio")) echo getParameter("id_anuncio"); ?>">
						...
						<div class="input-group mb-3">
							...
							<input type="hidden" name="foto_formats" value="160x120,320x240,480x640,800x600,1024x768,1366x768,1440x900">
							<input type="hidden" name="foto_path" value="anuncios">
							<div class="input-group-append">								
