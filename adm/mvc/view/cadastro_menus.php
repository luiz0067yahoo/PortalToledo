...
<div class="container">
	...
	<div class="row">
		<div class="sm-12">
			<form class="cadastro" id="cadastro_menu" action="/adm/mvc/controller/ControllerMenu.php" method="POST">
				...
				<div class="form-row align-items-center">
						...
						<div class="input-group mb-3">
							<label class="sr-only" for="inlineFormInputGroupicone">Icone</label>
							<div class="input-group-prepend">
								<div class="input-group-text">
									<i class="fa fa-bars" aria-hidden="true"></i>
								</div>
							</div>
							<input class="form-control" id="inlineFormInputGroupIcone" placeholder="Foto do Icone" name="icone" type="file"  accept="image/jpeg">
							<input type="hidden" name="icone_formats" value="160x120,320x240,640x480,480x640,800x600,1024x768,1366x768">
							<input type="hidden" name="icone_path" value="menu">
							<div class="input-group-append">								
								<button name="buscar" type="button" class="btn btn-primary buscarcampo buscaricone d-none"><i class="fa fa-search" aria-hidden="true"></i></button	>
							</div>
						</div>
						...
						<div class="input-group mb-3">
							...
							<input type="text" class="form-control" id="inlineFormInputGroupnome" placeholder="Nome do menu" name="nome" required>
							<div class="input-group-append">								
						...
						<div class="input-group mb-3">
							<label class="sr-only" for="inlineFormInputGrouptema">tema</label>
							<div class="input-group-prepend">
								<div class="input-group-text">
									<i class="fa fa-bars" aria-hidden="true"></i>
								</div>
							</div>
							<input type="text" class="form-control" id="inlineFormInputGrouptema" placeholder="Nome do tema" name="tema">
							<div class="input-group-append">								
								<button name="buscar" type="button" class="btn btn-primary buscarcampo buscartema d-none"><i class="fa fa-search" aria-hidden="true"></i></button	>
							</div>
						</div>
						...
						<div class="input-group mb-3">
							<label class="sr-only" for="inlineFormInputGroupdescricao">Descrição</label>
							<div class="input-group-prepend">
								<div class="input-group-text">
									<i class="fa fa-bars" aria-hidden="true"></i>
								</div>
							</div>
							<input type="text" class="form-control" id="inlineFormInputGroupdescricao" placeholder="Descrição do tema" name="descricao">
							<div class="input-group-append">								
						...
						<div class="input-group mb-3">
							...
							<div class="form-check">
								<input class="form-check-input" type="checkbox" id="ocultar" name="ocultar" value="1">
