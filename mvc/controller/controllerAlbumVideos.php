<?php
	...
	class controllerAlbumVideos extends controller
	{
		...
		public function __construct(){
			...
			if (notEmptyParameter(albumVideosDAO::id))
				$params[albumVideosDAO::id] = getParameter(albumVideosDAO::id);

			if (notEmptyParameter(albumVideosDAO::id_menu))
				$params[albumVideosDAO::id_menu] = getParameter(albumVideosDAO::id_menu);

			if (arrayKeyExistsParameter(albumVideosDAO::nome))
				$params[albumVideosDAO::nome] = trim(getParameter(albumVideosDAO::nome));

			if (issetParameter(albumVideosDAO::ocultar))
				$params[albumVideosDAO::ocultar] = getParameter(albumVideosDAO::ocultar) == "true";
