...
<div id="app">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="sm-12">
                <form class="cadastro" id="cadastro_album" method="POST" onsubmit="return false;">
                    <div class="form-row align-items-center">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" v-model="elementCurrent.nome" id="inlineFormInputGroupnome" placeholder="Nome do album" name="nome">
                            <div class="input-group-append">								
