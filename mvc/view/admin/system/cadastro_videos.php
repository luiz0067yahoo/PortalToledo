                ...
                <form class="cadastro" id="cadastro_video" method="POST" onsubmit="return false;">
                    <div class="form-row align-items-center">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" v-model="elementCurrent.nome" id="inlineFormInputGroupnome" placeholder="Nome do Vídeo" name="nome">
                            <div class="input-group-append">								
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input class="form-control" v-model="elementCurrent.video" id="inlineFormInputGroupVideo" placeholder="Link/Nome do Vídeo" name="video" type="text">
                        </div>
...
<script>
    var app = new Vue({
        ...
        data: {
            ...
            infoMsg: "",
            state: 'default',
            serverUrl: '/server/videos',
            serverAlbumUrl: '/server/albumVideos',
            elements: [],
            albums: [],
            elementCurrent: { id: "", id_album: "", nome: "", video: "", ocultar: false },
            pagination: {
                page: 1,
                rowCount: 10,
                total: 0,
        ...
        methods: {
            ...
            prepareNew() {
                this.clearMsg();
                this.elementCurrent = { id: "", id_album: "", nome: "", video: "", ocultar: false };
                this.state = 'new';
            },
            cancelAction() {
                this.errorMsg= "";
                ...
                this.infoMsg= "";
                this.state= 'default';
                this.serverUrl= '/server/videos';
                this.serverAlbumUrl= '/server/albumVideos';
                this.elements= [];
                this.albums= [];
                this.elementCurrent= { id: "", id_album: "", nome: "", video: "", ocultar: false };
                this.pagination= {
