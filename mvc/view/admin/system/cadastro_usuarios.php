        ...
        <div class="col-sm-12">
            <form class="cadastro" id="cadastro_menu" method="POST" enctype="multipart/form-data" onsubmit="return false;">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" v-model="elementCurrent.nome" placeholder="Nome do Usuário">
                </div>

                <div class="input-group mb-3">
                    <span class="input-group-text"><i class="fa fa-user"></i></span>
                    <input type="text" class="form-control" v-model="elementCurrent.login" placeholder="Login do Usuário">
                </div>

                <div class="input-group mb-3">
                    <span class="input-group-text"><i class="fa fa-envelope"></i></span>
                    <input type="text" class="form-control" v-model="elementCurrent.e_mail" placeholder="E-mail do Usuário">
                </div>

                <div class="input-group mb-3">
                    <span class="input-group-text"><i class="fa fa-key"></i></span>
                    <input type="password" class="form-control" v-model="elementCurrent.senha" placeholder="Senha do Usuário">
                </div>
...
<script type="module">
    ...
    createApp({
        setup() {
            ...
            // Config
            const serverUrl = '/server/usuarios';
            ...
            const prepareNew = () => {
                clearMsg();
                elementCurrent.value = { id: '', nome: '', login: '', senha: '' };
                state.value = 'new';
            };
