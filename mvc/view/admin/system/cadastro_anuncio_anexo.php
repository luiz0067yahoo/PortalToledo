...
<div class="container">
	...
	<div class="row">
		<div class="sm-12">
			<form class="cadastro" id="cadastro_anuncios_anexo" action="/mvc/controller/controllerAnuncioAnexo.php" method="POST" enctype="multipart/form-data" >
				...
				<div class="form-row align-items-center">
						<div class="input-group mb-3">
							...
							<input type="number" disabled data-bind="value:replyNumber" class="form-control" id="inlineFormInputGroupcodigo" placeholder="Código Anúncio" name="id_anuncio">
							<div class="input-group-append">								
								<button name="buscar" type="button" class="btn btn-primary buscarcampo buscarcodigo d-none"><i class="fa fa-search" aria-hidden="true"></i></button	>
							</div>
						</div>
						...
						<div class="input-group mb-3">
							...
							<textarea type="text" class="form-control ckeditor"   id="conteudo_anuncios_anexo" placeholder="Conteúdo da Anúncio" name="conteudo_anuncios_anexo"></textarea>
							<div class="input-group-append">								
