...
<div id="app" class="container">
    ...
    <div class="col-sm-12">
      <form class="cadastro" id="cadastro_config" method="POST" enctype="multipart/form-data" onsubmit="return false;">
        ...
        <div class="input-group mb-3">
          ...
          <input type="text" class="form-control" v-model="elementCurrent.mensagem_contato" placeholder="Mensagem Contato">
        </div>
  ...
  <div class="modal-overlay" v-if="showModal">
    <div class="modal-content-custom">
      <h4 v-if="itemToDelete" class="mb-4">{{ itemToDelete.mensagem_contato }}</h4>
...
<script type="module">
    ...
    setup() {
        ...
        const serverUrl = '/server/configs';
        ...
        return {
            ...
            elementCurrent, elements, 
            pagination, fileFields, 
