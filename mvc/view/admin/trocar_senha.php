	...
	<div class="row">
		<div class="sm-12">
			<form class="cadastro" id="cadastro_usuario" action="/mvc/model/usuariosDAO.php">
				...
				<input type="hidden" disabled data-bind="value:replyNumber" class="form-control"
					id="inlineFormInputGroupcodigo" placeholder="Código" name="id"
				...
				<div class="form-row align-items-center">
					...
					<div class="input-group mb-3">
						...
						<input type="password" class="form-control" id="inlineFormInputGroupsenhaatual"
							placeholder="Senha Atual" name="senha_atual">
					...
					<div class="input-group mb-3">
						...
						<input type="password" class="form-control" id="inlineFormInputGrouprepetirnovasenha"
							placeholder="Repetir Nova Senha" name="repetir_nova_senha">

					</div>


					<button name="trocar_senha" type="button" class="btn btn-primary acao "><i class="fa fa-key"
							aria-hidden="true"></i> Trocar Senha</button>
